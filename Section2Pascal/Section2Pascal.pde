...
void gasket(int levels, float v1x, float v1y, float v2x, float v2y, float v3x, float v3y) {
   if (levels > 1) {
     ...
     gasket(levels - 1, v2x, v2y, m1x, m1y, m2x, m2y);
     gasket(levels - 1, v3x, v3y, m2x, m2y, m3x, m3y);
     //gasket(levels-1, (v1x+v2x)/2, (v1y+v2y)/2, (v2x+v3x)/2, (v2y+v3y)/2, (v3x+v1x)/2, (v3y+v1y)/2);
   } else {
     triangle(v1x, v1y, v2x, v2y, v3x, v3y);
   }
}
